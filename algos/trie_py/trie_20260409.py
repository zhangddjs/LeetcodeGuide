...
# Daily practice file: trie_20260409.py
...
class Trie:
    ...
    def starts_with(self, prefix: str) -> bool:
        """
        The starts_with function in a trie is used to check if there's any word in the trie that begins with a given prefix.
        ...
        In essence, the starts_with function only verifies the existence of the prefix and doesn't require the "isEndOfWord" flag.
